...
class PddAdApiPlanUpdatePlanDiscountRequest extends PopBaseHttpRequest
{
    ...
    /**
     * @JsonProperty(\DawnFrost\Pdd\Api\Request\PddAdApiPlanUpdatePlanDiscountRequest_PlanDiscount, "planDiscount")
     */
...
class PddAdApiPlanUpdatePlanDiscountRequest_PlanDiscount extends PopBaseJsonEntity
{
    ...
    /**
     * @JsonProperty(List<\DawnFrost\Pdd\Api\Request\PddAdApiPlanUpdatePlanDiscountRequest_PlanDiscountDiscountsItem>, "discounts")
     */
    private $discounts;
