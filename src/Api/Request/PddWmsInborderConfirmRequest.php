...
class PddWmsInborderConfirmRequest extends PopBaseHttpRequest
{
	...
	/**
	* @JsonProperty(\DawnFrost\Pdd\Api\Request\PddWmsInborderConfirmRequest_Request, "request")
	*/
	private $request;
...
class PddWmsInborderConfirmRequest_Request extends PopBaseJsonEntity
{
	...
	/**
	* @JsonProperty(\DawnFrost\Pdd\Api\Request\PddWmsInborderConfirmRequest_RequestInbOrder, "inbOrder")
	*/
	private $inbOrder;

	/**
	* @JsonProperty(List<\DawnFrost\Pdd\Api\Request\PddWmsInborderConfirmRequest_RequestOrderLinesItem>, "orderLines")
	*/
	private $orderLines;
